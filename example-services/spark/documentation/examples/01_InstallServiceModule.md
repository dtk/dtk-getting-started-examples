...
In the text below and through the examples we both the commands in a form so they can be cut and paste and the full interactive session with user commands and the DTK responses
